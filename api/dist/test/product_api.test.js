...
test('HTTP POST request', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    expect(res.body.length).toBe(test_helper_1.default.initialProducts.length + 1);
}));
test('HTTP POST request with non token provided', () => __awaiter(void 0, void 0, void 0, function* () {
    const newProduct = {
        title: "Timberland Core Tree Logo hoodie in dark blue",
        desc: "Act casual, Drawstring hood, Large logo print to chest, Pouch pocket, Regular fit",
        img: [
    ...
    yield api
        ...
        .expect('Content-Type', /application\/json/);
    const res = yield api.get('/api/products');
    expect(res.body.length).toBe(test_helper_1.default.initialProducts.length);
}));
afterAll(() => {
